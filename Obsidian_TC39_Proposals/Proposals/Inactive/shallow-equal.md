 [[Inactive]]<br>Classification: [[API Change]]<br>Human Validated: KW<br>Title: Object.shallowEqual<br>Authors: Sebastian Markbage<br>Withdrawn<br>Last Presented: None<br>Stage Upgrades:<br>Stage 1: NA
Stage 2: NA  
Stage 2.7: NA  
Stage 3: NA  
Stage 4: NA<br>Last Commit: 2017-10-06<br>Topics: #others #memory<br>Keywords: #equality #memoization <br>GitHub Link: https://github.com/sebmarkbage/ecmascript-shallow-equal <br>GitHub Note Link: None
