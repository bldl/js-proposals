[[Inactive]]<br>Classification: [[Semantic Change]] [[Syntactic Change]]<br>Human Validated: KW<br>Title: Proposed Grammar change to ES Modules<br>Authors: Bradley Farias<br>Rejected: No consensus on this specific solution.<br>Last Presented: None<br>Stage Upgrades:<br>Stage 1: NA  
Stage 2: NA  
Stage 2.7: NA  
Stage 3: NA  
Stage 4: NA<br>Last Commit: 2017-04-06<br>Topics: #others #modules<br>Keywords: #grammar #ambiguity #module <br>GitHub Link: https://github.com/tc39/proposal-UnambiguousJavaScriptGrammar <br>GitHub Note Link: None
